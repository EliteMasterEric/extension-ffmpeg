...
NDK_CC="$NDKDIR/bin/i686-linux-android$API-clang"
NDK_CXX="$NDKDIR/bin/i686-linux-android$API-clang++"
...
NDK_AS="$NDKDIR/bin/i686-linux-android$API-clang"
...
OUTPUT_DIR=../lib.build/android-x86
mkdir -p $OUTPUT_DIR
